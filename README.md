...
Fortunately, we can filter this dataset down to a more manageable size (about 4 million rows) by only focusing on the top 16 presidential candidates. All of the data required to run the app can be found in the data folder within this repository. 
